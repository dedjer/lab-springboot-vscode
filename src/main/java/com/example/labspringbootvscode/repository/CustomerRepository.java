...
import com.example.labspringbootvscode.model.Customer;
...
public interface CustomerRepository extends JpaRepository<Customer, Long> {
    ...
    // Example REST Call:
    // http://localhost:8080/customers/search/findByNameLike?name=cia
    // Search by Like not working correctly. Need to work on this. Might need to try
    // Containing instead
